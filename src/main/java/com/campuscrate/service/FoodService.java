...
public class FoodService {
    ...
    public List<VendorOrderResponse> vendorOrders(Long userId) { return food.findVendorOrders(owner(userId).vendorId()); }
